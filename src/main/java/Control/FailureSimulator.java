    ...
    public void run() {
        ...
        while (true) {
            ...
            switch (sc.nextLine().trim()) {
                case "1": printer.setFailure(true);
                    System.out.println("[Sim] Printer failed"); break;
                case "2": /*latch.setFailure(true);*/
                    System.out.println("[Sim] Latch failed"); break;
                case "3": /*sd1.setFailure(true);*/
                    System.out.println("[Sim] SD1 failed"); break;
                case "4": screen.setFailure(true);
                    screen.turnOff();
                    System.out.println("[Sim] Screen off"); break;
                default:
